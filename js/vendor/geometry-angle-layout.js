...
(function(global) {
  ...
  const ANGLE_LABEL_SAMPLE_ROWS = Object.freeze([
    [350,260,"\\kappa","κ","small",20,22,58,0],
    [10,170,"\\chi","χ","medium",12,92,90,-1],
    [100,30,"\\varepsilon","ε","small",12,18,62,0],
    [50,190,"\\rho","ρ","medium",20,36,61,-3],
    [150,140,"\\sigma","σ","small",20,24,45,-2],
    [40,130,"o","ο","small",12,27,74,-2],
    [40,80,"\\varepsilon","ε","small",24,41,77,-2],
    [60,210,"\\alpha","α","small",14,23,60,0],
    [310,150,"\\pi","π","medium",22,20,45,5],
    [250,160,"\\alpha","α","small",22,21,40,8],
    [240,260,"\\rho","ρ","medium",24,23,52,5],
    [230,30,"\\kappa","κ","small",24,22,59,-10],
    [230,290,"\\zeta","ζ","large",22,26,48,0],
    [210,190,"\\lambda","λ","large",14,20,47,3],
    [240,270,"o","ο","small",24,22,54,10],
    [120,320,"\\iota","ι","small",14,16,60,8],
    [150,120,"\\gamma","γ","medium",14,16,55,0],
    [330,240,"\\tau","τ","small",16,17,55,3],
    [230,250,"\\lambda","λ","large",18,20,48,0],
    [350,260,"\\pi","π","medium",20,21,60,4],
    [270,250,"\\lambda","λ","large",22,22,52,0],
    [190,10,"\\theta","θ","medium",14,18,50,-3.5],
    [310,40,"\\chi","χ","medium",20,24,45,-17],
    [210,0,"\\varepsilon","ε","small",14,17,56,-2],
    [140,220,"\\gamma","γ","medium",24,26,46,0],
    [290,190,"\\alpha","α","small",18,20,49,22.5],
    [240,30,"o","ο","small",24,21,51,-8.5],
    [20,80,"\\psi","ψ","large",22,73,81,-0.5],
    [330,40,"\\varphi","φ","medium",16,20,47,-6],
    [310,170,"\\rho","ρ","medium",18,18,46,12.5],
    [180,40,"\\varepsilon","ε","small",16,19,52,-4.5],
    [80,20,"\\nu","ν","small",16,22,66,2],
    [200,50,"\\gamma","γ","medium",20,21,54,-6.5],
    [260,10,"\\iota","ι","small",18,17,52,-5.5],
    [240,40,"\\upsilon","υ","small",16,17,48,-7],
    [190,310,"\\delta","δ","large",24,26,47,0],
    [150,160,"\\eta","η","medium",12,16,50,0],
    [320,310,"\\theta","θ","medium",12,16,46,3.5],
    [130,60,"\\psi","ψ","large",22,26,55,0],
    [270,140,"\\nu","ν","small",14,16,43,7.5],
    [100,10,"\\lambda","λ","large",16,22,58,0],
    [280,190,"\\lambda","λ","large",18,20,44,6],
    [310,240,"\\theta","θ","medium",12,15.1,51,-7.5],
    [110,60,"\\beta","β","large",16,21.4,56,-2.5],
    [70,0,"\\chi","χ","medium",16,25,70,5.5],
    [10,220,"\\psi","ψ","large",24,145,90,0],
    [210,130,"\\alpha","α","small",22,20.7,44,-4],
    [250,0,"\\rho","ρ","medium",24,23,55,-2.9],
    [70,120,"\\nu","ν","small",20,29.3,65,-5],
    [300,350,"\\rho","ρ","medium",22,20,53,-6.9],
    [90,120,"\\mu","μ","medium",12,19.1,61,-3],
    [30,200,"\\varepsilon","ε","small",18,36.4,72.9,-2],
    [290,160,"\\eta","η","medium",18,19,43,9],
    [30,10,"\\rho","ρ","medium",24,52,78,4.5],
    [240,270,"o","ο","small",20,20,55,6.5],
    [290,60,"\\tau","τ","small",22,21,49.3,-6.5],
    [80,280,"\\nu","ν","small",22,28,62,2.1],
    [170,210,"\\eta","η","medium",12,16,49,-0.1],
    [100,200,"\\psi","ψ","large",22,30,54,-2.5],
    [340,200,"\\varphi","φ","medium",22,21,52,9.5],
    [310,290,"\\xi","ξ","large",12,19,55,0.5],
    [180,270,"\\alpha","α","small",18,20,55,10.5],
    [100,260,"\\rho","ρ","medium",20,25,52,4],
    [150,310,"\\lambda","λ","large",12,16,57,0.7],
    [240,290,"\\eta","η","medium",16,17.4,55,-6],
    [190,200,"\\sigma","σ","small",22,22,48,10.5],
    [100,10,"\\psi","ψ","large",20,27.1,59,1.5],
    [10,170,"\\mu","μ","medium",24,135.5,91,-1.5],
    [220,160,"\\xi","ξ","large",24,29,50,1.1],
    [60,100,"\\varphi","φ","medium",22,36.9,70,-4],
    [140,320,"\\eta","η","medium",20,22.1,59,5.5],
    [220,20,"\\gamma","γ","medium",12,15,49,4],
    [270,190,"\\alpha","α","small",12,16,52,17],
    [80,110,"\\rho","ρ","medium",18,24.8,67,-4.5],
    [300,280,"o","ο","small",24,23.6,55,1],
    [250,340,"\\kappa","κ","small",22,21.4,58,5],
    [30,320,"\\zeta","ζ","large",24,65,82,1],
    [40,140,"\\iota","ι","small",22,34,75,-4.5],
    [280,350,"\\varphi","φ","medium",14,18.7,48,3],
    [150,100,"\\iota","ι","small",16,17,52.4,-5.5],
    [290,90,"\\omega","ω","medium",24,24,44,-11],
    [120,0,"\\xi","ξ","large",12,20,55.7,0.5],
    [180,190,"\\nu","ν","small",20,21,45.7,3.5],
    [320,240,"\\alpha","α","small",18,19.7,59,3.5],
    [350,230,"\\psi","ψ","large",14,18,50,1],
    [10,200,"\\lambda","λ","large",20,138.3,91,0],
    [90,130,"\\upsilon","υ","small",20,22.9,62.2,-5.5],
    [110,50,"\\chi","χ","medium",12,19,63,-3.5],
    [90,210,"\\chi","χ","medium",24,32,49,0.8],
    [200,130,"\\lambda","λ","large",12,17,54,2.9],
    [250,70,"\\kappa","κ","small",20,21,50,-11],
    [170,60,"\\rho","ρ","medium",16,18,54,-7],
    [140,250,"\\zeta","ζ","large",16,23,50,-1.5],
    [140,220,"\\upsilon","υ","small",20,20.8,48,3.7],
    [220,0,"\\zeta","ζ","large",20,25,55,3],
    [180,350,"\\gamma","γ","medium",22,26,60,5.5],
    [350,130,"\\sigma","σ","small",12,17,52,11],
    [200,40,"\\varphi","φ","medium",14,19,49.2,-5.5],
    [240,230,"\\iota","ι","small",14,16.6,51.7,13],
    [130,290,"\\beta","β","large",14,22,58,0.5],
    [30,120,"\\beta","β","large",18,65,82,-0.5],
    [80,190,"\\theta","θ","medium",14,27,63,-1.5],
    [280,110,"\\pi","π","medium",22,26,43.9,-5],
    [70,280,"\\sigma","σ","small",22,33.4,63,5],
    [90,340,"o","ο","small",14,22,65,2.9],
    [130,90,"\\upsilon","υ","small",18,23,58,-4.5],
    [290,350,"\\varphi","φ","medium",24,25,53.4,-7.2],
    [260,130,"\\mu","μ","medium",18,21,40.6,2.5],
    [190,210,"\\upsilon","υ","small",18,19.6,47,4],
    [90,130,"\\varepsilon","ε","small",12,18,62.8,-4.5],
    [320,110,"\\iota","ι","small",22,22.7,46,2],
    [30,240,"\\eta","η","medium",14,45,75,0],
    [200,80,"\\omega","ω","medium",20,24,54,-7.5],
    [160,10,"\\psi","ψ","large",12,19,51.9,0.4],
    [10,240,"\\rho","ρ","medium",20,115,87,-1],
    [60,290,"\\lambda","λ","large",20,38,65,0.6],
    [160,350,"\\delta","δ","large",20,27,50.8,0.3],
    [110,270,"\\nu","ν","small",14,21,59,5.1],
    [270,190,"\\sigma","σ","small",18,20,50,14.5],
    [60,320,"\\pi","π","medium",16,31,67.4,4.5],
    [60,300,"\\gamma","γ","medium",14,30,66,2.5],
    [200,0,"\\varepsilon","ε","small",20,22.3,58,-4],
    [240,270,"\\delta","δ","large",22,25,48.8,-1],
    [350,100,"\\varphi","φ","medium",24,26,43,1.5],
    [180,290,"\\omega","ω","medium",12,18,58,-1.2],
    [120,330,"\\beta","β","large",12,22,58.2,0.4],
    [300,200,"\\omega","ω","medium",22,24,52,8.5],
    [230,350,"\\varepsilon","ε","small",14,18,56,-2.6],
    [250,200,"\\delta","δ","large",12,18,52,3.2],
    [160,0,"\\gamma","γ","medium",16,21,55,0],
    [190,200,"\\varepsilon","ε","small",12,17,50,6.3],
    [100,60,"\\delta","δ","large",22,31,58.5,-1],
    [310,140,"\\gamma","γ","medium",12,18,46.2,4.7],
    [330,160,"\\lambda","λ","large",24,25,46,4.3],
    [340,10,"\\beta","β","large",14,20,50,0],
    [280,120,"\\varepsilon","ε","small",20,20,42,2.6],
    [200,70,"\\xi","ξ","large",14,20,53.2,1.5],
    [350,60,"\\chi","χ","medium",18,24,42,-16],
    [290,270,"\\varphi","φ","medium",20,24,62,-0.9],
    [230,200,"\\varphi","φ","medium",12,16,53.3,4.5],
    [330,220,"\\theta","θ","medium",24,23.6,52,-3.5],
    [340,150,"\\rho","ρ","medium",20,20,45,9.5],
    [240,250,"\\nu","ν","small",22,23,53.3,3.5],
    [240,10,"\\lambda","λ","large",18,24,49,2],
    [270,210,"\\nu","ν","small",12,17,53,9.5],
    [320,40,"\\rho","ρ","medium",18,23,47,-9.2],
    [140,100,"\\beta","β","large",20,25,57,-4.5],
    [160,60,"\\beta","β","large",22,25.5,52,1.5],
    [60,300,"\\theta","θ","medium",22,39.2,68,0],
    [140,30,"\\chi","χ","medium",22,29,67,-2.5],
    [170,140,"\\beta","β","large",12,19,55,2.5],
    [290,200,"\\mu","μ","medium",16,19,51,6.2],
    [290,150,"\\rho","ρ","medium",16,17,44.8,15.5],
    [260,70,"\\delta","δ","large",14,19,51,-9.5],
    [200,80,"\\upsilon","υ","small",20,23,54,-4.5],
    [160,300,"\\xi","ξ","large",12,19,52.9,-2],
    [150,20,"\\alpha","α","small",18,20,62,-2],
    [270,40,"\\varepsilon","ε","small",18,18,49,-10.5],
    [130,260,"\\iota","ι","small",24,25.7,49,4.1],
    [290,20,"\\nu","ν","small",12,15,49.8,-3.3],
    [80,150,"\\varepsilon","ε","small",20,27,62,-5],
    [230,40,"\\rho","ρ","medium",16,19,51,-3],
    [170,210,"\\rho","ρ","medium",18,21.2,45,2.5],
    [280,120,"\\theta","θ","medium",20,24,50,1.4],
    [110,310,"\\pi","π","medium",16,23,59,3.1],
    [190,20,"\\varphi","φ","medium",14,21,53,-5],
    [120,330,"\\beta","β","large",20,29,57.5,1.5],
    [330,280,"\\pi","π","medium",18,22,59,-0.5],
    [150,10,"\\tau","τ","small",18,21,60,-1.2],
    [100,210,"\\chi","χ","medium",24,34,49.7,0.8],
    [170,120,"\\pi","π","medium",22,26,51,-4.4],
    [30,290,"\\alpha","α","small",16,46,76,3],
    [150,190,"\\iota","ι","small",20,22,47,2.3],
    [300,310,"\\alpha","α","small",12,18,56,1.5],
    [90,130,"\\upsilon","υ","small",12,21,62.7,-3.9],
    [10,100,"o","ο","small",14,98,91.8,-1],
    [250,90,"\\chi","χ","medium",16,25,47,-17.5],
    [160,100,"\\eta","η","medium",12,19,54,2.5],
    [270,250,"\\psi","ψ","large",22,27,50,0.4],
    [140,100,"\\delta","δ","large",16,23,56,-1.5],
    [80,180,"\\eta","η","medium",14,27,62.1,-1.7],
    [180,180,"\\tau","τ","small",18,22,47.7,4],
    [180,250,"\\psi","ψ","large",24,29.3,51,2],
    [260,90,"\\rho","ρ","medium",14,23,44,-5.5],
    [60,160,"\\nu","ν","small",20,33,64.6,-4],
    [310,320,"\\tau","τ","small",18,19,56.8,5],
    [260,110,"\\nu","ν","small",14,18,47,3.5],
    [310,100,"\\iota","ι","small",16,17.5,45,-3.5],
    [160,350,"\\pi","π","medium",18,24,61,1.5],
    [300,350,"\\nu","ν","small",20,22,51.4,-5],
    [20,180,"o","ο","small",22,62,81.8,-2],
    [100,280,"\\varphi","φ","medium",18,26,58,4.5],
    [270,190,"\\beta","β","large",18,21,51,6],
    [50,150,"\\sigma","σ","small",16,32,70,-2.7],
    [60,30,"\\beta","β","large",24,45,65.1,1.5],
    [50,350,"\\pi","π","medium",16,36,70,2.5],
    [80,200,"\\sigma","σ","small",16,24,61,-0.8],
    [270,260,"\\iota","ι","small",14,17,56,6.5],
    [70,130,"\\zeta","ζ","large",20,38,69,-2],
    [290,270,"\\mu","μ","medium",20,26,60,-7],
    [350,50,"\\xi","ξ","large",16,22,48.7,-8],
    [300,290,"\\eta","η","medium",16,23,53,-3],
    [320,280,"\\kappa","κ","small",14,18,58,-2],
    [20,340,"\\omega","ω","medium",16,60,83.7,2],
    [40,270,"\\beta","β","large",16,42,77,-1.5],
    [290,150,"\\lambda","λ","large",20,24,48,8],
    [200,250,"\\varepsilon","ε","small",20,22,51,8.5],
    [140,130,"\\mu","μ","medium",24,30,51,-4],
    [310,340,"\\beta","β","large",16,23,50,10.5],
    [180,120,"\\psi","ψ","large",16,25,54,-1.5],
    [340,330,"\\beta","β","large",18,23,49,0.2],
    [290,200,"\\upsilon","υ","small",16,22,47,6.5],
    [110,150,"\\varepsilon","ε","small",20,26,59,-8],
    [220,80,"\\theta","θ","medium",12,18,53,-2.5],
    [190,50,"\\sigma","σ","small",24,25.7,53.6,-9],
    [80,160,"\\lambda","λ","large",24,34,61,-1.9],
    [350,250,"\\rho","ρ","medium",22,24,62,1.5],
    [160,60,"\\lambda","λ","large",20,25,56,-7.5],
    [250,180,"\\sigma","σ","small",18,21,49,10.5],
    [140,240,"\\alpha","α","small",12,18,55,6],
    [240,130,"\\theta","θ","medium",20,24,52,-2],
    [350,290,"\\gamma","γ","medium",22,25,58,5],
    [310,170,"\\mu","μ","medium",16,21,48,7.5],
    [110,330,"\\gamma","γ","medium",18,26,59,5.5],
    [150,210,"\\kappa","κ","small",20,21.2,47,3.2],
    [240,270,"\\eta","η","medium",22,23,53,2.3],
    [60,210,"\\beta","β","large",12,28,69,1],
    [330,10,"\\beta","β","large",18,22.9,50,-0.5],
    [80,50,"\\psi","ψ","large",14,24,61,-0.5],
    [90,120,"\\varepsilon","ε","small",14,21,64,-5.5],
    [30,320,"\\zeta","ζ","large",16,53,80.1,0.7],
    [300,60,"\\gamma","γ","medium",14,19,53,-3],
    [350,280,"\\rho","ρ","medium",14,19,56,0.7],
    [10,110,"\\psi","ψ","large",16,126.1,91,0],
    [280,220,"\\eta","η","medium",14,19.4,50,4.5],
    [30,260,"\\delta","δ","large",14,41,78,-0.5],
    [80,110,"\\delta","δ","large",20,29.2,65,-0.5],
    [190,160,"\\theta","θ","medium",22,25.6,54,-1.5],
    [140,250,"\\psi","ψ","large",18,25.4,52,0],
    [70,350,"\\theta","θ","medium",22,34.9,68.1,2.4],
    [190,290,"\\upsilon","υ","small",20,21.9,55,5.2],
    [170,50,"\\omega","ω","medium",20,24,56,-6.5],
    [340,210,"\\varphi","φ","medium",18,21,54,5.5],
    [200,30,"\\chi","χ","medium",20,24,61,-10.5],
    [310,10,"\\iota","ι","small",14,16.5,53.7,-1.5],
    [310,40,"\\sigma","σ","small",14,18,50,-6],
    [340,60,"\\sigma","σ","small",22,21,46,-5],
    [330,340,"\\mu","μ","medium",22,24.4,55,-8.5],
    [340,250,"\\beta","β","large",16,24,53,-5.5],
    [100,190,"\\upsilon","υ","small",16,23,57,-1.6],
    [60,60,"\\upsilon","υ","small",16,31,72,0],
    [40,270,"\\varepsilon","ε","small",14,35.8,72.2,2],
    [240,140,"\\pi","π","medium",20,22.5,43,-4],
    [320,220,"\\beta","β","large",20,25,50,-0.5],
    [110,280,"\\eta","η","medium",24,30.5,57,6.5],
    [210,300,"\\nu","ν","small",16,20,58,-1],
    [40,340,"\\delta","δ","large",20,43.6,74.6,0.8],
    [70,190,"\\delta","δ","large",18,33.1,67,-0.5],
    [90,50,"\\psi","ψ","large",18,29,62,-0.5],
    [120,220,"\\beta","β","large",24,32.5,56,-5],
    [140,70,"\\zeta","ζ","large",18,23.4,59,-0.5],
    [20,70,"\\sigma","σ","small",14,57,86,0],
  ]);
